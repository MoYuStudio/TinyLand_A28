...
# 基础属性
@export var building_name: String = "building"  # 建筑物名称
@export var is_passable: bool = false        # 是否可通过
@export var is_enterable: bool = true        # 是否可进入
@export var is_destructible: bool = true     # 是否可破坏
@export var is_light_source: bool = false    # 是否发光

# 建筑物属性
@export var health: float = 100.0            # 建筑物生命值
@export var max_health: float = 100.0        # 最大生命值
@export var construction_time: float = 5.0   # 建造时间
@export var construction_cost: int = 100     # 建造成本
@export var maintenance_cost: int = 10       # 维护成本
